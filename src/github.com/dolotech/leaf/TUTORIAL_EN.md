...
* Multi-core support. Leaf utilize its modules and [leaf/go](https://github.com/davy66666/poker-go/src/github.com/name5566/leaf/tree/master/go) to make use of CPU resouces at maximum while avoiding varieties of side effects may be caused.
...
A game server implemented with Leaf may include many modules (e.g. [LeafServer](https://github.com/davy66666/poker-go/src/github.com/name5566/leafserver)) which all share below traits:

* Each module runs inside a separate goroutine
* Modules communicate with one another via a light weight RPC channel([leaf/chanrpc](https://github.com/davy66666/poker-go/src/github.com/name5566/leaf/tree/master/chanrpc))
...
[LeafServer](https://github.com/davy66666/poker-go/src/github.com/name5566/leafserver) is a game server developped with Leaf. Let's start with it.

Download the source code of LeafServer：

```
git clone https://github.com/davy66666/poker-go/src/github.com/name5566/leafserver
```

Download and install leafserver to GOPATH:

```
go get github.com/davy66666/poker-go/src/github.com/name5566/leaf
```
...
import (
    "github.com/davy66666/poker-go/src/github.com/name5566/leaf/network"
)
...
import (
    "github.com/davy66666/poker-go/src/github.com/name5566/leaf/network/json"
)
...
import (
    ...
    "github.com/davy66666/poker-go/src/server/msg"
)
...
import (
    "github.com/davy66666/poker-go/src/github.com/name5566/leaf/log"
    "github.com/davy66666/poker-go/src/github.com/name5566/leaf/gate"
    "reflect"
    "github.com/davy66666/poker-go/src/server/msg"
)
...
import (
    "github.com/davy66666/poker-go/src/server/game/internal"
)
...
import (
    "github.com/davy66666/poker-go/src/github.com/name5566/leaf/module"
...
More references are at [leaf/go](https://github.com/davy66666/poker-go/src/github.com/name5566/leaf/blob/master/go)。
...
More references are at [leaf/timer](https://github.com/davy66666/poker-go/src/github.com/name5566/leaf/blob/master/timer)。
...
More references are at [leaf/log](https://github.com/davy66666/poker-go/src/github.com/name5566/leaf/blob/master/log).

### Leaf recordfile

Leaf recordfile is formatted in CSV([Example](https://github.com/davy66666/poker-go/src/github.com/name5566/leaf/blob/master/recordfile/test.txt)). recordfile is to manage the configuration for game. The usage of recordfile in LeafServer is quite simple:
...
Refer to [leaf/recordfile](https://github.com/davy66666/poker-go/src/github.com/name5566/leaf/blob/master/recordfile) for more details.

Learn more
----------

More references are at Wiki [https://github.com/davy66666/poker-go/src/github.com/name5566/leaf/wiki](https://github.com/davy66666/poker-go/src/github.com/name5566/leaf/wiki)
